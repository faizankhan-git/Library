...
import com.books.library.config.audit.AuditEventConverter;
import com.books.library.domain.PersistentAuditEvent;
...
import static com.books.library.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
