...
describe('Service Tests', () => {
  describe('Books Service', () => {
    ...
    beforeEach(() => {
      ...
      elemDefault = new Books('ID', 'AAAAAAA', 'AAAAAAA', 0, currentDate, 'AAAAAAA', 0, 'AAAAAAA');
    });
    ...
    describe('Service methods', () => {
      ...
      it('should create a Books', () => {
        ...
        service.create(new Books()).subscribe(resp => (expectedResult = resp.body));
